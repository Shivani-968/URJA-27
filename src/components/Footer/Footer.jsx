      ...
      <div className="footer-main">
        <div className="footer-col footer-about">
          ...
          <p className="footer-desc">
            URJA, NIT Jamshedpur's annual national-level sports festival, is one
            of the largest of its kind in Eastern India. With a staggering
            turnout of over 8000+ footfall including students, professionals,
            educators, and athletes from top colleges across the nation.
          </p>
        </div>
        ...
        <div className="footer-col footer-links">
          ...
          <ul>
            ...
            <li>
              <Link to="/branch-leaderboard">Leaderboard</Link>
            </li>
            <li>
        ...
        <div className="footer-col footer-follow">
          ...
          <div className="footer-social">
            <a
              href="https://www.facebook.com/urjanitjsr/"
              target="_blank"
